...
calculate = function(K_ind,K_snp,N_grm,M_grm,fn_y1,fn_y2,dout){
    ...
    ## read GRMs 
    grm_all = as.matrix(fread('/z/Comp/lu_group/Members/jsong/Sibling/coding/dosage/all_ordered/line1_rmed/chr_all_grm_zs.rel',fill=TRUE,sep='\t'))
    ...
    CHR = 1:22
    snpblock = length(list.files(path = '/z/Comp/lu_group/Members/jsong/Sibling/coding/UKB/3.snpjack/map',pattern = paste0('chr',CHR,'_block*')))
